    ...
    <div class="home-content" :class="{ 'has-editorial': editorialUnlocked }">
      <div class="title-ornament" aria-hidden="true">
        ...
        ><svg viewBox="0 0 32 40">
          <path d="M16 2 30 20 16 38 2 20Z" />
          <path d="m16 12 6 8-6 8-6-8Z" /></svg
        ><span></span>
      </div>
      <h1 class="home-title" aria-label="符文档案">
        <button
          ...
          :key="character"
          type="button"
          class="title-character font-display"
      ...
      <div class="home-entries" aria-label="档案入口">
        ...
        >
          <svg
            ...
            aria-hidden="true"
          >
            <path class="art-sheet" d="M35 12h90v80H35z" />
            <path d="M47 26h42M47 32h25M47 78h66" />
            <path
              class="art-bars"
              d="M51 70V56h10v14m14 0V45h10v25m14 0V36h10v34"
            />
            <path
              class="art-accent"
              d="m44 56 26-14 21 5 25-27m-11 1 11-1-1 11"
            />
          </svg>
        ...
        <button type="button" class="entry-card" @click="comingSoon">
          ...
          >
            <path
              class="art-sheet"
              d="M80 28c-15-10-33-13-54-10v64c20-3 38 0 54 10 16-10 34-13 54-10V18c-21-3-39 0-54 10Z"
            />
            <path
              d="M80 28v64M38 35c11 0 21 2 30 6M38 47c11 0 21 2 30 6M38 59c11 0 21 2 30 6M92 41c9-4 19-6 30-6M92 53c9-4 19-6 30-6"
            />
        ...
        >
          ...
          >
            ...
            <rect
              ...
              height="76"
              rx="4"
              transform="rotate(10 94 50)"
            />
            <path class="art-accent" d="m94 29 13 23-20 17-13-23Z" />
            <path d="m92 40 6 11-9 8-6-11Z" />
          </svg>
        ...
        >
          ...
          >
            ...
            <path
              class="art-accent"
              d="m77 64 34-40 10 9-34 40-15 5Z M105 31l10 9M77 64l10 9"
            />
          </svg>
      ...
      <div class="home-shortcuts" aria-label="小工具">
        ...
        >
          <svg viewBox="0 0 20 20" fill="none" aria-hidden="true">
            <path
              d="M4 3v4a3 3 0 0 0 3 3h6a3 3 0 0 1 3 3v4"
              stroke-width="1.5"
...
.title-rule {
  ...
  align-items: center;
  gap: 7px;
  margin: 24px auto clamp(28px, 5vh, 52px);
}
.title-rule i {
  width: 3px;
  height: 3px;
