...
function baseFromRow(r: Row): CardBase {
  return {
    ...
    nameKr: text(r.card_name_kr),
    nameTw: text(r.card_name_tw),
    subtitleCn: text(r.sub_title_cn),
    subtitleEn: text(r.sub_title_en),
    subtitleKr: text(r.sub_title_kr),
    subtitleTw: text(r.sub_title_tw),
    ...
    effectKr: text(r.effect_kr),
    effectTw: text(r.effect_tw),
